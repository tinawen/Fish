...
- (id)initWithPathForResource:(NSString *)pathForResource {
	...
	NSString *themesFilePath = [[NSBundle mainBundle] pathForResource:pathForResource ofType:@"plist"];
	...
	for (NSString *oneKey in themesDictionary) {
		...
		VSTheme *theme = [[VSTheme alloc] initWithDictionary:themesDictionary[oneKey] andFileName:pathForResource];
